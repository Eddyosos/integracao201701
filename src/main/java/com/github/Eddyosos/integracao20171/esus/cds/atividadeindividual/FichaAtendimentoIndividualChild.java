...
public class FichaAtendimentoIndividualChild {
    ...
    private FichaAtendimentoIndividualChildThrift instance;
    ...
    public ProblemaCondicaoAvaliacaoAIThrift getProblemaCondicaoAvaliada() {
        return instance.getProblemaCondicaoAvaliada();
    }

    public void setProblemaCondicaoAvaliada(ProblemaCondicaoAvaliacaoAIThrift problemaCondicaoAvaliada) {
        instance.setProblemaCondicaoAvaliada(problemaCondicaoAvaliada);
    }
    ...
    public Iterator<OutrosSiaThrift> getOutrosSiaIterator() {
        return instance.getOutrosSiaIterator();
    }
